...
![Live Grafana dashboard — simulator producing 150 pings/sec across Paris, p50/p95/p99 ingest latency, Kafka consumer throughput, JVM heap.](docs/grafana-dashboard.gif)
